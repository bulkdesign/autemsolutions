...
define( 'GS_CONNECTOR_VERSION', '1.5' );
define( 'GS_CONNECTOR_DB_VERSION', '1.5' );
...
class Gs_Connector_Init {
         ...
         <div class="card" id="googlesheet">
            ...
            <div class="inside">
               ...
               <p>
                  ...
                  <input type="text" name="gs-code" id="gs-code" value="" placeholder="<?php if ( get_option('gs_token') !== '' ) { echo esc_html( __( 'Currently Active', 'gsconnector' ) ); } ?>"/>
   ...
   /**
	...
	private static function delete_for_site() {
      Gs_Connector_Utility::instance()->logger( "Inside delete for site");
