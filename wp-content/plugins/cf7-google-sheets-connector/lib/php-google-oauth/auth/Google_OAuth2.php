...
class Google_OAuth2 extends Google_Auth {
  ...
  public function authenticate($service, $code = null) {
    ...
    if ($code) {
      ...
      $request = CF7GSC_Google_Client::$io->makeRequest(new Google_HttpRequest(self::OAUTH2_TOKEN_URI, 'POST', array(), array(
          'code' => $code,
      ...
      if ($request->getResponseHttpCode() == 200) {
		...
		Gs_Connector_Utility::gs_debug_log("Error fetching OAuth2 access token, message: '$response' :: {$request->getResponseHttpCode()}");
    ...
    if ($this->isAccessTokenExpired()) {
      if ($this->assertionCredentials) {
        ...
        if (! array_key_exists('refresh_token', $this->token)) {
			Gs_Connector_Utility::gs_debug_log("The OAuth 2.0 access token has expired, "
  ...
  private function refreshTokenRequest($params) {
    ...
    $request = CF7GSC_Google_Client::$io->makeRequest($http);
  ...
  public function revokeToken($token = null) {
    ...
    $response = CF7GSC_Google_Client::$io->makeRequest($request);
  ...
  private function getFederatedSignOnCerts() {
    ...
    $request = CF7GSC_Google_Client::$io->makeRequest(new Google_HttpRequest(
