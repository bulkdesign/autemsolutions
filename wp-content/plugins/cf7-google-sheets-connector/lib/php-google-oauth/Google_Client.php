...
class CF7GSC_Google_Client {
  ...
  public function addService($service, $version = false) {
    ...
    if ($this->authenticated) {
      throw new Google_Exceptions('Cant add services after having authenticated');
    }
   ...
   * or CF7GSC_Google_Client#getAccessToken().
  ...
  public static function getAuth() {
    return CF7GSC_Google_Client::$auth;
  }
  ...
  public static function getIo() {
    return CF7GSC_Google_Client::$io;
  }
  ...
  public function getCache() {
    return CF7GSC_Google_Client::$cache;
  }
}

// Exceptions that the Google PHP API Library can throw
class Google_Exceptions extends Exception {}
class Google_AuthException extends Google_Exceptions {}
class Google_CacheException extends Google_Exceptions {}
class Google_IOException extends Google_Exceptions {}
class Google_ServiceException extends Google_Exceptions {
  /**
